...
LastEditTime: 2021-05-14 23:33:46
...
class Solution(object):
    def decodeString(self, s):
        ...
        注意这里multiply是上个'['到当前'['的字符串中的数字，例如"3[a2[c]]"中的'a'，
        result_str实际是last_result_str,即上个'['到当前'['的字符串中的字母字符串，例如"3[a2[c]]"中的'a'，
        或者如'3[aa2[]]
        4.当碰到']'时，stack出栈一对(multiply,result_str)
