...
LastEditTime: 2021-05-14 23:43:11
...
class Solution(object):
    def decodeString(self, s):
        ...
        result_str实际是left_unencoded_string,即上个'['到当前'['的字符串中的（左侧未）字母字符串（不是右侧括号'['和']'中的encoded_string），
        ...
        即result_str（新encoded_string）=multiply*result_str（原encoded_string）+left_unencoded_string
