...
LastEditTime: 2021-05-14 23:37:56
...
class Solution(object):
    def decodeString(self, s):
        ...
        4.当碰到']'时，stack出栈一对(multiply,last_result_str)，解码字符串并与result_str中的字符串（原encoded_string）进行拼接（新原encoded_string），
        即result_str（new_）=multiply*result_str+last_result_str
